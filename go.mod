...
require (
	...
	github.com/kube-logging/telemetry-controller v0.0.0-20260917101346-3af840d6c3c3
...
require (
	...
	github.com/open-telemetry/opentelemetry-operator/apis v0.159.0 // indirect
...
// A stale logging-operator self-reference drags in the monolith, which still carried
// apis/v1beta1 before v0.156.0 and so made that import ambiguous.
exclude (
