...
| **[Authentication config for syslog-ng outputs](syslogng-outputs/auth/)** | syslogng-outputs | Authentication config for syslog-ng outputs | Testing | [](https://axoflow.com/docs/axosyslog-core/chapter-destinations/syslog-ng-with-loki/#auth) |
