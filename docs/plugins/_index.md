...
| **[Amazon Elasticsearch](outputs/aws_elasticsearch/)** | outputs | Fluent plugin for Amazon Elasticsearch | Testing | [1.0.0](https://github.com/atomita/fluent-plugin-aws-elasticsearch-service) |
