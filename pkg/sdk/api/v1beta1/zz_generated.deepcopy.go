...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FluentdDrainWatchConfig) DeepCopyInto(out *FluentdDrainWatchConfig) {
	*out = *in
	in.Image.DeepCopyInto(&out.Image)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FluentdDrainWatchConfig.
func (in *FluentdDrainWatchConfig) DeepCopy() *FluentdDrainWatchConfig {
	if in == nil {
		return nil
	}
	out := new(FluentdDrainWatchConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FluentdScaling) DeepCopyInto(out *FluentdScaling) {
	*out = *in
	if in.DrainWatch != nil {
		in, out := &in.DrainWatch, &out.DrainWatch
		*out = new(FluentdDrainWatchConfig)
		(*in).DeepCopyInto(*out)
	}
}
