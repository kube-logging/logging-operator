...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExceptionDetectorOutputConfig) DeepCopyInto(out *ExceptionDetectorOutputConfig) {
	*out = *in
	if in.Languages != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExceptionDetectorOutputConfig.
func (in *ExceptionDetectorOutputConfig) DeepCopy() *ExceptionDetectorOutputConfig {
	if in == nil {
		return nil
	}
	out := new(ExceptionDetectorOutputConfig)
	in.DeepCopyInto(out)
	return out
}
