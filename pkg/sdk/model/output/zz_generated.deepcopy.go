...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GclOutputConfig) DeepCopyInto(out *GclOutputConfig) {
	*out = *in
	if in.Buffer != nil {
		in, out := &in.Buffer, &out.Buffer
		*out = new(Buffer)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GclOutputConfig.
func (in *GclOutputConfig) DeepCopy() *GclOutputConfig {
	if in == nil {
		return nil
	}
	out := new(GclOutputConfig)
	in.DeepCopyInto(out)
	return out
}
