...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebsocketOutput) DeepCopyInto(out *WebsocketOutput) {
	*out = *in
	if in.UseMsgpack != nil {
		in, out := &in.UseMsgpack, &out.UseMsgpack
		*out = new(bool)
		**out = **in
	}
	if in.AddTime != nil {
		in, out := &in.AddTime, &out.AddTime
		*out = new(bool)
		**out = **in
	}
	if in.AddTag != nil {
		in, out := &in.AddTag, &out.AddTag
		*out = new(bool)
		**out = **in
	}
	if in.Token != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebsocketOutput.
func (in *WebsocketOutput) DeepCopy() *WebsocketOutput {
	if in == nil {
		return nil
	}
	out := new(WebsocketOutput)
	in.DeepCopyInto(out)
	return out
}
