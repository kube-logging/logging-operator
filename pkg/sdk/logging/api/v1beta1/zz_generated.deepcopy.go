...
func (in *FluentbitSpec) DeepCopyInto(out *FluentbitSpec) {
	*out = *in
	...
	if in.TargetLoggings != nil {
		in, out := &in.TargetLoggings, &out.TargetLoggings
		*out = make([]TargetLogging, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetLogging) DeepCopyInto(out *TargetLogging) {
	*out = *in
	if in.Namespaces != nil {
		in, out := &in.Namespaces, &out.Namespaces
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetLogging.
func (in *TargetLogging) DeepCopy() *TargetLogging {
	if in == nil {
		return nil
	}
	out := new(TargetLogging)
	in.DeepCopyInto(out)
	return out
}
