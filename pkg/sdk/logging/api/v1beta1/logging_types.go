...
type LoggingSpec struct {
	...
	// that can be managed by the Telmetry Controller.
...
type RouteConfig struct {
	...
	// If EnableTelemtryControllerRoute set to true, the opoerator will create
	...
	TenantLabels *metav1.LabelSelector `json:"tenantLabels,omitempty"`
}
