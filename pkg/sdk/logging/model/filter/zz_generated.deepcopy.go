...
func (in *ParseSection) DeepCopyInto(out *ParseSection) {
	*out = *in
    ...
    if in.GrokPatterns != nil {
        ...
        *out = make([]SingleGrokSection, len(*in))
        copy(*out, *in)
    }
}
...
func (in *SingleGrokSection) DeepCopyInto(out *SingleGrokSection) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SingleParseSection.
func (in *SingleGrokSection) DeepCopy() *SingleGrokSection {
	if in == nil {
		return nil
	}
	out := new(SingleGrokSection)
	in.DeepCopyInto(out)
	return out
}
