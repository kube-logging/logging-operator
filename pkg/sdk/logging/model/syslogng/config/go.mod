...
require (
	...
	github.com/kube-logging/logging-operator v0.0.0-20241217115247-7855f88f78cf // indirect
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.79.1 // indirect
