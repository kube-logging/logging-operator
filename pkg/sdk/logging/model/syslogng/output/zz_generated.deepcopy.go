...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchDatastreamOutput) DeepCopyInto(out *ElasticsearchDatastreamOutput) {
	*out = *in
...
func (in *ElasticsearchDatastreamOutput) DeepCopy() *ElasticsearchDatastreamOutput {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchDatastreamOutput)
	in.DeepCopyInto(out)
	return out
}
