...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LMLogsOutputConfig) DeepCopyInto(out *LMLogsOutputConfig) {
	*out = *in
	if in.AccessID != nil {
	...
	if in.DeviceLessLogs != nil {
		in, out := &in.DeviceLessLogs, &out.DeviceLessLogs
		*out = new(bool)
		**out = **in
	}
	if in.Buffer != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LMLogsOutputConfig.
func (in *LMLogsOutputConfig) DeepCopy() *LMLogsOutputConfig {
	if in == nil {
		return nil
	}
	out := new(LMLogsOutputConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NullOutputConfig) DeepCopyInto(out *NullOutputConfig) {
	*out = *in
	if in.NeverFlush != nil {
		in, out := &in.NeverFlush, &out.NeverFlush
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RabbitMQOutputConfig) DeepCopyInto(out *RabbitMQOutputConfig) {
	*out = *in
	if in.Hosts != nil {
	...
	if in.TLSCACertificates != nil {
		in, out := &in.TLSCACertificates, &out.TLSCACertificates
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RabbitMQOutputConfig.
func (in *RabbitMQOutputConfig) DeepCopy() *RabbitMQOutputConfig {
	if in == nil {
		return nil
	}
	out := new(RabbitMQOutputConfig)
	in.DeepCopyInto(out)
	return out
}
