...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CopyOutputConfig) DeepCopyInto(out *CopyOutputConfig) {
	*out = *in
	if in.Stores != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CopyOutputConfig.
func (in *CopyOutputConfig) DeepCopy() *CopyOutputConfig {
	if in == nil {
		return nil
	}
	out := new(CopyOutputConfig)
	in.DeepCopyInto(out)
	return out
}
