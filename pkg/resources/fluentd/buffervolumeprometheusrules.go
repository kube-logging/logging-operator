...
func (r *Reconciler) bufferVolumePrometheusRules() (runtime.Object, reconciler.DesiredState, error) {
	...
	if r.fluentdSpec.BufferVolumeMetrics != nil && r.fluentdSpec.BufferVolumeMetrics.IsEnabled() && r.fluentdSpec.BufferVolumeMetrics.PrometheusRules {
		maps.Copy(obj.Labels, r.fluentdSpec.BufferVolumeMetrics.PrometheusRulesLabels)
		...
		rules := builtInRules
		if r.fluentdSpec.BufferVolumeMetrics.PrometheusRulesOverride != nil {
			for _, o := range r.fluentdSpec.BufferVolumeMetrics.PrometheusRulesOverride {
