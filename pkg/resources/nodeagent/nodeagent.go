...
func New(client client.Client, logger logr.Logger, logging *v1beta1.Logging, agents map[string]v1beta1.NodeAgentConfig, opts reconciler.ReconcilerOpts, loggingDataProvider loggingdataprovider.LoggingDataProvider) *Reconciler {
	return &Reconciler{
		Logging:                   logging,
...
func (r *Reconciler) processAgent(name string, userDefinedAgent v1beta1.NodeAgentConfig) (*reconcile.Result, error) {
	...
	instance = nodeAgentInstance{
		...
		logging:             r.Logging,
		loggingDataProvider: r.loggingDataProvider,
	}
